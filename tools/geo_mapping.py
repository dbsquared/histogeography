...
底图: rendered/china_full_v3.tif / rendered/china_full_v3.png
尺寸: 15600 x 9600
...
def elevation_at(lon, lat, tif_path='rendered/china_full_v3.tif'):
...
def elevation_grid(tif_path='rendered/china_full_v3.tif', downsample=10):
